...
public final class RecordPresenterImpl extends BasePresenterImpl<RecordView> implements RecordPresenter {
    /**
     * The interactor
     */
    @NonNull
    ...
    @Inject
    public RecordPresenterImpl(@NonNull RecordInteractor interactor) {
